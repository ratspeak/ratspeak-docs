...
A reference for the terms used throughout the Ratspeak and Reticulum docs. Read [What is Reticulum?](../concepts/what-is-reticulum.md) first if you want the short conceptual overview; use this page when a word needs a precise meaning.
