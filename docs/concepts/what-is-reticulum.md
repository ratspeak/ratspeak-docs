...
Read [Key Concepts & Glossary](../concepts/key-concepts-and-glossary.md) when you need names for the moving parts. Read [Protocol Architecture](../concepts/protocol-architecture.md) when you want the routing and packet model. Read [Links & LXMF](../concepts/links-and-lxmf.md) for messaging behavior. Read [Cryptography & Protection](../concepts/cryptography-and-protection.md) for the security model and its limits.
