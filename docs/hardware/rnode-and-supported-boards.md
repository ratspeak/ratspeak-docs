...
2. **An antenna** matched to your frequency band (SMA connector, usually included). See [Antennas, Range & Power](../hardware/antennas-range-and-power.md).
...
After choosing a board, read [Antennas, Range & Power](../hardware/antennas-range-and-power.md), then [Flashing Firmware](../hardware/flashing-firmware.md).
