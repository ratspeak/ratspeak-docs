...
| Tool | Path |
|---|---|
| Ratspeak app | `<OS data dir>/org.ratspeak.desktop/.ratspeak/identities/<hash>/identity` (see [Install & Platform Setup](../getting-started/install-and-platform-setup.md) for the per-OS data directory) |
