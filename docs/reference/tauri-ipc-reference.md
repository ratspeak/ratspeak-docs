...
| `voice`      | 7             | Experimental LXST voice surface — service start/stop, status, call/answer/reject/hangup. Only compiled in when the `lxst-voice` Cargo feature is on; see [rsLXST](../products/rslxst.md). |
